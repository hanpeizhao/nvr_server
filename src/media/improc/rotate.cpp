...
void Rotate::reverse_inplace_quad(u_char *src, int size) {
...
void Rotate::flip_inplace_horizontal(u_char *src, int width, int height) {
  uint8_t *nsrc, *ndst;
  uint8_t tmp;
  int l, w;
...
void Rotate::flip_inplace_vertical(u_char *src, int width, int height) {
  uint8_t *nsrc, *ndst;
  uint8_t tmp;
  int l;
...
void Rotate::rot90cw(u_char *src, u_char *dst, int size, int width,
                     int height) {
  u_char *endp;
  u_char *base;
  int j;
...
void Rotate::rot90ccw(u_char *src, u_char *dst, int size, int width,
                      int height) {
  u_char *endp;
  u_char *base;
  int j;
...
void Rotate::process(ctx_image_data *img_data) {
  /*
...
Rotate::Rotate(Camera_t *p_cam) {
  ...
  /* 1. Transfer capture dimensions into capture_width_norm and
   * capture_height_norm. */
