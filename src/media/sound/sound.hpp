...
struct ctx_snd_alert {
  ...
  int volume_count;     /* For each sample, number of times required to exceed
                           volumne level*/
  ...
  int trigger_threshold; /* How many times does it need to be triggered before
                            an event*/
