...
enum PARM_ACT { PARM_ACT_DFLT, PARM_ACT_SET, PARM_ACT_GET, PARM_ACT_LIST };
...
struct ctx_parm_depr {
  ...
  const std::string info;    /* Short text on why it was deprecated (removed,
                                replaced with, etc) */
...
public:
  ...
  void edit_get(std::string parm_nm, std::string &parm_val,
                enum PARM_CAT parm_cat);
  void edit_get(std::string parm_nm, std::list<std::string> &parm_val,
                enum PARM_CAT parm_cat);
  void edit_list(std::string parm_nm, std::string &parm_val,
                 enum PARM_CAT parm_cat);
  ...
  void parms_log();
  void parms_write();
  void parms_copy(Config *src);
  void parms_copy(Config *src, PARM_CAT p_cat);
...
private:
  ...
  void parms_write_parms(FILE *conffile, std::string parm_nm,
  ...
  void edit_depr_vid(std::string parm_nm, std::string newname,
                     std::string parm_val);
  ...
  void edit_cat(std::string parm_nm, std::list<std::string> &parm_val,
                enum PARM_ACT pact, enum PARM_CAT pcat);
  void edit_cat(std::string parm_nm, std::string &parm_val, enum PARM_ACT pact,
                enum PARM_CAT pcat);
  void edit_cat00(std::string cmd, std::string &parm_val, enum PARM_ACT pact);
  void edit_cat01(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat02(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat03(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat04(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat05(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat06(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat07(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat08(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat09(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat10(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat11(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat12(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat13(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat14(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat15(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat16(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat17(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat18(std::string parm_nm, std::string &parm_val,
                  enum PARM_ACT pact);
  void edit_cat18(std::string parm_nm, std::list<std::string> &parm_val,
                  enum PARM_ACT pact);
